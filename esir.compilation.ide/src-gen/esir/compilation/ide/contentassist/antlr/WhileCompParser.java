		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getExprAccess().getExprAndAssignment(), "rule__Expr__ExprAndAssignment");
					put(grammarAccess.getExprAndAccess().getExprOrAssignment_0(), "rule__ExprAnd__ExprOrAssignment_0");
					put(grammarAccess.getExprAndAccess().getExprAndAssignment_1_1(), "rule__ExprAnd__ExprAndAssignment_1_1");
					put(grammarAccess.getExprOrAccess().getExprNotAssignment_0(), "rule__ExprOr__ExprNotAssignment_0");
					put(grammarAccess.getExprOrAccess().getExprOrAssignment_1_1(), "rule__ExprOr__ExprOrAssignment_1_1");
					...
					put(grammarAccess.getExprEqAccess().getExprSimple1Assignment_0(), "rule__ExprEq__ExprSimple1Assignment_0");
					put(grammarAccess.getExprEqAccess().getExprSimple2Assignment_1_1(), "rule__ExprEq__ExprSimple2Assignment_1_1");
