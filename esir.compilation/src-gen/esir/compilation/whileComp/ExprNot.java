...
public interface ExprNot extends EObject
{
   ...
   * @see #setNot(Not)
   * @see esir.compilation.whileComp.WhileCompPackage#getExprNot_Not()
  ...
  /**
   * Sets the value of the '{@link esir.compilation.whileComp.ExprNot#getNot <em>Not</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see esir.compilation.whileComp.WhileCompPackage#getExprNot_ExprEq()
   * @model containment="true"
   * @generated
   */
  ExprEq getExprEq();
  ...
  /**
   * Sets the value of the '{@link esir.compilation.whileComp.ExprNot#getExprEq <em>Expr Eq</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
