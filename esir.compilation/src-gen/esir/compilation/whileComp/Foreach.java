 ...
 * <ul>
 *   <li>{@link esir.compilation.whileComp.Foreach#getExpr1 <em>Expr1</em>}</li>
 *   <li>{@link esir.compilation.whileComp.Foreach#getExpr2 <em>Expr2</em>}</li>
 *   <li>{@link esir.compilation.whileComp.Foreach#getCommands <em>Commands</em>}</li>
 * </ul>
 * </p>
 *
 * @see esir.compilation.whileComp.WhileCompPackage#getForeach()
 * @model
 * @generated
 */
public interface Foreach extends EObject
{
   ...
   * @see #setExpr1(Expr)
   * @see esir.compilation.whileComp.WhileCompPackage#getForeach_Expr1()
  ...
  /**
   * Sets the value of the '{@link esir.compilation.whileComp.Foreach#getExpr1 <em>Expr1</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setExpr2(Expr)
   * @see esir.compilation.whileComp.WhileCompPackage#getForeach_Expr2()
   * @model containment="true"
   * @generated
   */
  Expr getExpr2();
  ...
  /**
   * Sets the value of the '{@link esir.compilation.whileComp.Foreach#getExpr2 <em>Expr2</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see esir.compilation.whileComp.WhileCompPackage#getForeach_Commands()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link esir.compilation.whileComp.Foreach#getCommands <em>Commands</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
