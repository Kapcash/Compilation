...
public interface If extends EObject
{
   ...
   * @see #setExpr(Expr)
   * @see esir.compilation.whileComp.WhileCompPackage#getIf_Expr()
  ...
  /**
   * Sets the value of the '{@link esir.compilation.whileComp.If#getExpr <em>Expr</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see esir.compilation.whileComp.WhileCompPackage#getIf_Commands1()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link esir.compilation.whileComp.If#getCommands1 <em>Commands1</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see esir.compilation.whileComp.WhileCompPackage#getIf_Commands2()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link esir.compilation.whileComp.If#getCommands2 <em>Commands2</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
