...
//	private LinkedList<String> allDecls = new LinkedList<String>();
	...
	public CS_Translator3(ThreeAddressCode code) {
		super();
		this.code = code;
	}
...
*/	
	...
	private class CS_Function {
		...
		public void printFunction() throws CS_TranslatorException {
			...
			CS_Translator3.this.newLine();
			CS_Translator3.this.write("private static " + getReturns() + " " + getName() + "(" + getParams() + ")");
			CS_Translator3.this.write(lAccolade);
			CS_Translator3.this.write2(body.toString());
			CS_Translator3.this.write(rAccolade);
		}
