...
public class WhileCompGenerator extends AbstractGenerator {
  ...
  public String compile(final Command c, final int indentBase, final int indentAll, final int indentFor, final int indentWhile, final int indentIf, final int indentForeach, final int indentAff) {
    ...
    if ((_command_3 instanceof While)) {
      ...
      String _plus = ((decal_2 + "while ") + _compile_1);
      ...
      String _plus_2 = (_plus_1 + _compile_2);
      String _plus_3 = (_plus_2 + "\n");
    ...
    if ((_command_6 instanceof For)) {
      ...
      String _plus_9 = (_plus_8 + decal_3);
      return (_plus_9 + "od");
    }
    ...
    if ((_command_9 instanceof Foreach)) {
      ...
      String _plus_14 = (_plus_13 + _compile_7);
      String _plus_15 = (_plus_14 + "\n");
      String _plus_16 = (_plus_15 + decal_4);
      return (_plus_16 + "od");
    }
    ...
    if ((_command_13 instanceof If)) {
      ...
      if (_notEquals) {
        ...
        String _plus_17 = ((decal_5 + "if ") + _compile_8);
        String _plus_18 = (_plus_17 + " then\n");
        ...
        String _plus_19 = (_plus_18 + _compile_9);
        ...
        String _plus_26 = ((decal_5 + "if ") + _compile_11);
        String _plus_27 = (_plus_26 + " then\n");
        ...
        String _plus_28 = (_plus_27 + _compile_12);
        String _plus_29 = (_plus_28 + "\n");
        String _plus_30 = (_plus_29 + decal_5);
        return (_plus_30 + "fi");
      }
    }
    return null;
  ...
  public String compile(final Affectation aff) {
    ...
    if (_equals) {
      ...
      final int valSize = _valeurs_1.size();
      while ((i < (valSize - 1))) {
        {
          String _res_1 = res;
          EList<Expr> _valeurs_2 = aff.getValeurs();
          Expr _get_3 = _valeurs_2.get(i);
  ...
  public String compile(final ExprSimple expr) {
    String ret = "";
    Expr _ex1 = expr.getEx1();
    boolean _notEquals = (!Objects.equal(_ex1, null));
    if (_notEquals) {
      String _ret = ret;
      Expr _ex1_1 = expr.getEx1();
      Object _compile = this.compile(_ex1_1);
      String _plus = ("(" + _compile);
      String _plus_1 = (_plus + " ");
      String _ope = expr.getOpe();
      String _plus_2 = (_plus_1 + _ope);
      String _plus_3 = (_plus_2 + " ");
      Expr _ex2 = expr.getEx2();
      Object _compile_1 = this.compile(_ex2);
      ...
      if (_notEquals_1) {
        ...
        if (_notEquals_2) {
          ...
          String _plus_10 = ("(" + _ope_1);
          String _plus_11 = (_plus_10 + " ");
          Lexpr _lexpr_2 = expr.getLexpr();
          Object _compile_3 = this.compile(_lexpr_2);
        ...
        if (_notEquals_3) {
          Not _n = expr.getN();
          boolean _notEquals_4 = (!Objects.equal(_n, null));
          if (_notEquals_4) {
            String _ret_3 = ret;
            Not _n_1 = expr.getN();
            String _not = _n_1.getNot();
            ...
            String _plus_17 = ("(" + _ope_2);
            String _plus_18 = (_plus_17 + " ");
            Expr _expr_2 = expr.getExpr();
            Object _compile_5 = this.compile(_expr_2);
