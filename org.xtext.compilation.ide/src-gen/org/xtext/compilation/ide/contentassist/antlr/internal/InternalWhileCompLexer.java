...
public class InternalWhileCompLexer extends Lexer {
    ...
    public final void mT__22() throws RecognitionException {
        try {
            int _type = T__22;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:19:7: ( 'for' )
            // InternalWhileComp.g:19:9: 'for'
            {
            match("for"); 
    ...
    public final void mT__25() throws RecognitionException {
        try {
            int _type = T__25;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:22:7: ( 'if' )
            // InternalWhileComp.g:22:9: 'if'
            {
            match("if"); 
    ...
    public final void mT__26() throws RecognitionException {
        try {
            int _type = T__26;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:23:7: ( 'then' )
            // InternalWhileComp.g:23:9: 'then'
            {
            match("then"); 
    ...
    public final void mT__27() throws RecognitionException {
        try {
            int _type = T__27;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:24:7: ( 'fi' )
            // InternalWhileComp.g:24:9: 'fi'
            {
            match("fi"); 
    ...
    public final void mT__29() throws RecognitionException {
        try {
            int _type = T__29;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:26:7: ( 'foreach' )
            // InternalWhileComp.g:26:9: 'foreach'
            {
            match("foreach"); 
    ...
    public final void mT__30() throws RecognitionException {
        try {
            int _type = T__30;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:27:7: ( 'in' )
            // InternalWhileComp.g:27:9: 'in'
            {
            match("in"); 
    ...
    public final void mRULE_VARIABLE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:4907:15: ( 'A' .. 'Z' ( 'A' .. 'Z' | 'a' .. 'z' )* )
            // InternalWhileComp.g:4907:17: 'A' .. 'Z' ( 'A' .. 'Z' | 'a' .. 'z' )*
            {
            matchRange('A','Z'); 
            // InternalWhileComp.g:4907:26: ( 'A' .. 'Z' | 'a' .. 'z' )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_SYMBOL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:4909:13: ( 'a' .. 'z' ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' )* ( ( ( '-' | '+' | '.' | '/' | '_' | '&' ) | '->' ) ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' )+ )* ( '!' | '?' )? )
            // InternalWhileComp.g:4909:15: 'a' .. 'z' ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' )* ( ( ( '-' | '+' | '.' | '/' | '_' | '&' ) | '->' ) ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' )+ )* ( '!' | '?' )?
            {
            matchRange('a','z'); 
            // InternalWhileComp.g:4909:24: ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' )*
            loop2:
            do {
                int alt2=2;
            ...
            // InternalWhileComp.g:4909:54: ( ( ( '-' | '+' | '.' | '/' | '_' | '&' ) | '->' ) ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' )+ )*
            loop5:
            do {
                int alt5=2;
                ...
                switch (alt5) {
            	case 1 :
            	    // InternalWhileComp.g:4909:55: ( ( '-' | '+' | '.' | '/' | '_' | '&' ) | '->' ) ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' )+
            	    {
            	    // InternalWhileComp.g:4909:55: ( ( '-' | '+' | '.' | '/' | '_' | '&' ) | '->' )
            	    int alt3=2;
            	    ...
            	    // InternalWhileComp.g:4909:88: ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' )+
            	    int cnt4=0;
            	    loop4:
            	    do {
            	        int alt4=2;
    ...
    public final void mRULE_NOMBRE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:4911:13: ( '1' .. '9' ( '0' .. '9' )* )
            // InternalWhileComp.g:4911:15: '1' .. '9' ( '0' .. '9' )*
            {
            matchRange('1','9'); 
            // InternalWhileComp.g:4911:24: ( '0' .. '9' )*
            loop7:
            do {
                int alt7=2;
                ...
                switch (alt7) {
            	case 1 :
            	    // InternalWhileComp.g:4911:25: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:4913:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalWhileComp.g:4913:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalWhileComp.g:4913:11: ( '^' )?
            int alt8=2;
            ...
            // InternalWhileComp.g:4913:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:4915:10: ( ( '0' .. '9' )+ )
            // InternalWhileComp.g:4915:12: ( '0' .. '9' )+
            {
            // InternalWhileComp.g:4915:12: ( '0' .. '9' )+
            int cnt10=0;
            loop10:
            do {
                ...
                switch (alt10) {
            	case 1 :
            	    // InternalWhileComp.g:4915:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:4917:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalWhileComp.g:4917:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalWhileComp.g:4917:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt13=2;
            ...
            switch (alt13) {
                case 1 :
                    // InternalWhileComp.g:4917:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalWhileComp.g:4917:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop11:
                    do {
                        int alt11=3;
                    ...
                    break;
                case 2 :
                    // InternalWhileComp.g:4917:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalWhileComp.g:4917:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop12:
                    do {
                        int alt12=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:4919:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalWhileComp.g:4919:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalWhileComp.g:4919:24: ( options {greedy=false; } : . )*
            loop14:
            do {
                int alt14=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:4921:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalWhileComp.g:4921:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalWhileComp.g:4921:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop15:
            do {
                int alt15=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:4923:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalWhileComp.g:4923:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalWhileComp.g:4923:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt18=0;
            loop18:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:4925:16: ( . )
            // InternalWhileComp.g:4925:18: .
            {
            matchAny(); 
    ...
    static final String DFA19_acceptS =
        "\3\uffff\1\3\1\uffff\1\5\1\uffff\1\10\7\uffff\1\25\1\uffff\1\27\1\30\10\uffff\1\42\1\43\3\uffff\1\47\1\50\3\uffff\1\40\2\uffff\1\7\1\2\1\3\1\uffff\1\5\2\uffff\1\10\7\uffff\1\23\1\24\1\25\1\26\1\27\1\30\5\uffff\1\37\1\uffff\1\42\1\41\1\uffff\1\43\1\44\1\45\1\46\1\47\2\uffff\1\16\4\uffff\1\12\1\13\1\14\1\21\1\uffff\1\36\5\uffff\1\35\2\uffff\1\11\5\uffff\1\31\1\32\4\uffff\1\4\2\uffff\1\15\1\17\1\33\1\34\2\uffff\1\6\1\22\3\uffff\1\20\1\1";
