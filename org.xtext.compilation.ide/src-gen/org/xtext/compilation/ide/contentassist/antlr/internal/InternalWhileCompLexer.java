...
public class InternalWhileCompLexer extends Lexer {
    ...
    public final void mT__22() throws RecognitionException {
        try {
            int _type = T__22;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:19:7: ( 'while' )
            // InternalWhileComp.g:19:9: 'while'
            {
            match("while"); 
    ...
    public final void mT__23() throws RecognitionException {
        try {
            int _type = T__23;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:20:7: ( 'do' )
            // InternalWhileComp.g:20:9: 'do'
            {
            match("do"); 
    ...
    public final void mT__24() throws RecognitionException {
        try {
            int _type = T__24;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:21:7: ( 'od' )
            // InternalWhileComp.g:21:9: 'od'
            {
            match("od"); 
    ...
    public final void mT__25() throws RecognitionException {
        try {
            int _type = T__25;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:22:7: ( 'for' )
            // InternalWhileComp.g:22:9: 'for'
            {
            match("for"); 
    ...
    public final void mT__28() throws RecognitionException {
        try {
            int _type = T__28;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:25:7: ( 'else' )
            // InternalWhileComp.g:25:9: 'else'
            {
            match("else"); 
    ...
    public final void mT__30() throws RecognitionException {
        try {
            int _type = T__30;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:27:7: ( 'foreach' )
            // InternalWhileComp.g:27:9: 'foreach'
            {
            match("foreach"); 
    ...
    public final void mT__31() throws RecognitionException {
        try {
            int _type = T__31;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:28:7: ( 'in' )
            // InternalWhileComp.g:28:9: 'in'
            {
            match("in"); 
    ...
    public final void mT__39() throws RecognitionException {
        try {
            int _type = T__39;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:36:7: ( 'nil' )
            // InternalWhileComp.g:36:9: 'nil'
            {
            match("nil"); 
    ...
    public final void mRULE_VARIABLE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:4876:15: ( 'A' .. 'Z' ( 'A' .. 'Z' | 'a' .. 'z' )* )
            // InternalWhileComp.g:4876:17: 'A' .. 'Z' ( 'A' .. 'Z' | 'a' .. 'z' )*
            {
            matchRange('A','Z'); 
            // InternalWhileComp.g:4876:26: ( 'A' .. 'Z' | 'a' .. 'z' )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_SYMBOL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:4878:13: ( 'a' .. 'z' ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' )* ( ( ( '-' | '+' | '.' | '/' | '_' | '&' ) | '->' ) ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' )+ )* ( '!' | '?' )? )
            // InternalWhileComp.g:4878:15: 'a' .. 'z' ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' )* ( ( ( '-' | '+' | '.' | '/' | '_' | '&' ) | '->' ) ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' )+ )* ( '!' | '?' )?
            {
            matchRange('a','z'); 
            // InternalWhileComp.g:4878:24: ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' )*
            loop2:
            do {
                int alt2=2;
            ...
            // InternalWhileComp.g:4878:54: ( ( ( '-' | '+' | '.' | '/' | '_' | '&' ) | '->' ) ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' )+ )*
            loop5:
            do {
                int alt5=2;
                ...
                switch (alt5) {
            	case 1 :
            	    // InternalWhileComp.g:4878:55: ( ( '-' | '+' | '.' | '/' | '_' | '&' ) | '->' ) ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' )+
            	    {
            	    // InternalWhileComp.g:4878:55: ( ( '-' | '+' | '.' | '/' | '_' | '&' ) | '->' )
            	    int alt3=2;
            	    ...
            	    // InternalWhileComp.g:4878:88: ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' )+
            	    int cnt4=0;
            	    loop4:
            	    do {
            	        int alt4=2;
    ...
    public final void mRULE_NOMBRE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:4880:13: ( '1' .. '9' ( '0' .. '9' )* )
            // InternalWhileComp.g:4880:15: '1' .. '9' ( '0' .. '9' )*
            {
            matchRange('1','9'); 
            // InternalWhileComp.g:4880:24: ( '0' .. '9' )*
            loop7:
            do {
                int alt7=2;
                ...
                switch (alt7) {
            	case 1 :
            	    // InternalWhileComp.g:4880:25: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:4882:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalWhileComp.g:4882:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalWhileComp.g:4882:11: ( '^' )?
            int alt8=2;
            ...
            // InternalWhileComp.g:4882:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:4884:10: ( ( '0' .. '9' )+ )
            // InternalWhileComp.g:4884:12: ( '0' .. '9' )+
            {
            // InternalWhileComp.g:4884:12: ( '0' .. '9' )+
            int cnt10=0;
            loop10:
            do {
                ...
                switch (alt10) {
            	case 1 :
            	    // InternalWhileComp.g:4884:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:4886:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalWhileComp.g:4886:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalWhileComp.g:4886:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt13=2;
            ...
            switch (alt13) {
                case 1 :
                    // InternalWhileComp.g:4886:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalWhileComp.g:4886:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop11:
                    do {
                        int alt11=3;
                    ...
                    break;
                case 2 :
                    // InternalWhileComp.g:4886:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalWhileComp.g:4886:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop12:
                    do {
                        int alt12=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:4888:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalWhileComp.g:4888:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalWhileComp.g:4888:24: ( options {greedy=false; } : . )*
            loop14:
            do {
                int alt14=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:4890:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalWhileComp.g:4890:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalWhileComp.g:4890:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop15:
            do {
                int alt15=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:4892:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalWhileComp.g:4892:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalWhileComp.g:4892:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt18=0;
            loop18:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhileComp.g:4894:16: ( . )
            // InternalWhileComp.g:4894:18: .
            {
            matchAny(); 
    ...
    static final String DFA19_eotS =
        "\1\uffff\1\45\1\51\1\uffff\1\45\1\uffff\1\45\1\uffff\5\45\2\41\1\uffff\1\41\2\uffff\4\45\1\102\1\45\1\105\1\41\2\uffff\3\41\2\uffff\2\45\1\116\1\uffff\1\45\1\104\3\uffff\1\45\1\uffff\2\45\1\uffff\1\123\1\124\1\125\1\126\1\45\1\130\1\45\6\uffff\4\45\1\136\1\uffff\1\102\2\uffff\1\105\5\uffff\1\45\1\141\1\uffff\4\45\4\uffff\1\45\1\uffff\1\45\1\147\1\150\2\45\1\uffff\2\45\1\uffff\1\155\2\45\1\160\1\161\2\uffff\1\162\1\163\2\45\1\uffff\1\166\1\167\4\uffff\2\45\2\uffff\1\45\1\173\1\174\2\uffff";
