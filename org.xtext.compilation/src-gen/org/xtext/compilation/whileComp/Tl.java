 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.compilation.whileComp.Tl#getTl <em>Tl</em>}</li>
 * </ul>
 *
 * @see org.xtext.compilation.whileComp.WhileCompPackage#getTl()
 * @model
 * @generated
 */
public interface Tl extends EObject
{
   ...
   * @see #setTl(String)
   * @see org.xtext.compilation.whileComp.WhileCompPackage#getTl_Tl()
   * @model
   * @generated
   */
  String getTl();
  ...
  /**
   * Sets the value of the '{@link org.xtext.compilation.whileComp.Tl#getTl <em>Tl</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
