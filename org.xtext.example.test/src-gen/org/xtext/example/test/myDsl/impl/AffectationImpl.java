 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.test.myDsl.impl.AffectationImpl#getValeur <em>Valeur</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AffectationImpl extends CommandImpl implements Affectation
{
  ...
  public void setValeur(int newValeur)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.AFFECTATION__VALEUR, oldValeur, valeur));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.AFFECTATION__VALEUR:
        return getValeur();
    }
