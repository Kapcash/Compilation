 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.test.myDsl.impl.ReadImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReadImpl extends MinimalEObjectImpl.Container implements Read
{
  ...
  public EList<String> getName()
  {
    if (name == null)
    {
      name = new EDataTypeEList<String>(String.class, this, MyDslPackage.READ__NAME);
    }
    return name;
  }
